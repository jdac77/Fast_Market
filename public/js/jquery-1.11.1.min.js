/*! jQuery v1.11.1 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function(a, b) {
            ...
            return e !== n && 9 === e.nodeType && e.documentElement ?
                ((n = e),
                    ...
                    (c.getById = ib(function(a) {
                        return (
                            (o.appendChild(a).id = u), !e.getElementsByName ||
        ...
        (fb.matchesSelector = function(a, b) {
            if (
                ((a.ownerDocument || a) !== n && m(a),
                    (b = b.replace(U, "='$1']")), !(!c.matchesSelector ||
                        !p ||
                        (r && r.test(b)) ||
                        (q && q.test(b))
                    ))
    ...
    m.fn.extend({
        ...
        is: function(a) {
            return !!w(
                this,
                "string" == typeof a && t.test(a) ? m(a) : a || [], !1
            ).length;
        }
    });
    var x,
    ...
    function Bb(a, b) {
        ...
        if (1 === b.nodeType) {
            if (
                ((c = b.nodeName.toLowerCase()), !k.noCloneEvent && b[m.expando])
            ) {
                e = m._data(b);
    ...
    m.extend({
            clone: function(a, b, c) {
                ...
                if (b)
                    if (c)
                        for (
                            h = h || ub(a), d = d || ub(f), g = 0; null != (e = h[g]); g++
                        )
                            Ab(e, d[g]);
                    else Ab(a, f);
                return (
        ...
        m.fn.extend({
            ...
            domManip: function(a, b) {
                ...
                if (
                    ...
                    for (
                        g = m.map(ub(i, "script"), xb), f = g.length; l > j; j++
                    )
                        (d = i),
                        j !== o &&
                        ((d = m.clone(d, !0, !0)),
        ...
        m.each({
            ...
            function(a, b) {
                m.fn[a] = function(a) {
                    for (
                        var c, d = 0, e = [], g = m(a), h = g.length - 1; h >= d; d++
                    )
