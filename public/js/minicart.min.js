...
!(function a(b, c, d) {
    ...
    1: [
        function(a, b, c) {
            ...
            (c.map = function(a, b) {
                ...
                for (
                    var c = new Array(a.length), d = 0; d < a.length; d++
                )
                    c[d] = b(a[d], d, a);
                return c;
            }),
    ...
    3: [
        function(a, b, c) {
            ...
            (c.resolve = function() {
                for (
                    var a = "", b = !1, c = arguments.length - 1; c >= -1 && !b; c--
                ) {
        ...
        function(a, b, c) {
            ...
            function h(a, b, d) {
                ...
                var o = G.keys(b),
                    p = g(o);
                if (
                    (a.showHidden && (o = G.getOwnPropertyNames(b)),
                        0 === o.length)
                ) {
                    if (z(b)) {
                        var q = b.name ? ": " + b.name : "";
                    ...
                    if (x(b))
                        return a.stylize(
                            Date.prototype.toString.call(b),
                            "date"
                        );
                    if (y(b)) return j(b);
                }
            ...
            function k(a, b, c, d, e) {
                for (var f = [], g = 0, h = b.length; h > g; ++g)
                    f.push(
                        F(b, String(g)) ? l(a, b, c, d, String(g), !0) : ""
                    );
                return (
        ...
        function(a, b) {
            ...
            i(c.prototype, e.prototype),
                ...
                (c.prototype.add = function(a) {
                    ...
                    for (c in a)
                        g.SETTINGS.test(c) &&
                        ((this._settings[c] = a[c]), delete a[c]);
                ...
                (c.prototype.discount = function(a) {
                    var b =
                        parseFloat(this.settings("discount_amount_cart")) ||
                        0;
                    return (
                        b ||
                        (b =
                            ((parseFloat(
                                    this.settings("discount_rate_cart")
                                ) || 0) *
                                this.subtotal()) /
                            100),
                        (a = a || {}),
                ...
                (c.prototype.remove = function(a) {
                    ...
                    return (
                        ...
                        b && (this.save(), this.fire("remove", a, b[0])), !!b.length
                    );
                }),
    ...
    10: [
        function(a, b) {
            ...
            var c = a("./util/mixin"),
                d = (b.exports = {
                    name: "PPMiniCart",
                    parent: "undefined" != typeof document ?
                        document.body :
                        null,
            ...
            f(c.prototype, e.prototype),
                    ...
                    if (!this._options) {
                        for (a = [], e = 0;
                            ...
                            for (
                                ...
                                "undefined" !=
                                typeof this.get("option_select" + f);

                            ) {
                                if (this.get("option_select" + f) === c) {
                                    d = g.amount(
                                        this.get("option_amount" + f)
                                    );
                                    break;
                                }
                                f++;
                ...
                (c.prototype.discount = function(a) {
                    ...
                    return (
                        ...
                        ((h = 0),
                            (e =
                                parseInt(this.get("discount_num"), 10) ||
                                0),
                            ...
                            ((b = g.amount(
                                ...
                                (h +=
                                    g.amount(
                                        this.get("discount_amount2") || b
                                    ) * f)) :
                            void 0 !== this.get("discount_rate") &&
                            ((c = g.amount(
                                    this.get("discount_rate")
                                )),
                                (i = this.amount()),
                                (h += (c * i) / 100),
                                (h +=
                                    (g.amount(
                                            this.get("discount_rate2") || c
                                        ) *
                                        i *
                                        f) /
                                    100)),
    ...
    22: [
        function(a, b) {
            ...
            (c.prototype.show = function() {
                this.isShowing ||
                    (h.add(document.body, j.SHOWING_CLASS),
                        (this.isShowing = !0));
            }),
            (c.prototype.hide = function() {
                this.isShowing &&
                    (h.remove(document.body, j.SHOWING_CLASS),
                        (this.isShowing = !1));
            }),
